  ...
  return (
    <div className="Header">
      <div className="Header__social-links">
        <div className="Header__social-links-container">
        <a
        ...
        <a href="http://twitter.com/caseytrees" target="_blank">
          <svg
            viewBox="0 0 21 17"
            xmlns="http://www.w3.org/2000/svg"
            className="twitter"
        ...
        <a href="http://instagram.com/CaseyTrees" target="_blank">
          <svg
            viewBox="0 0 18 17"
            xmlns="http://www.w3.org/2000/svg"
            className="instagram"
        ...
        <a href="http://www.youtube.com/caseytrees" target="_blank">
          <svg
            viewBox="0 0 26 17"
            xmlns="http://www.w3.org/2000/svg"
            className="youtube"
